          ...
          <div className="col-lg-12">
            <div className="row row-gap-3">
              ...
              <div className="col-lg-3 col-md-6  col-md-6">
                <div className="committeeContainer">
                  <div className="othersMembersImage">
                    <img src="/images/managing/shubhankar.jpg" alt="" />
                  </div>
                  <div className="committeeMemberDetails">
              ...
              <div className="col-lg-3 col-md-6  col-md-6">
                <div className="committeeContainer">
                  <div className="othersMembersImage">
                    <img src="/images/managing/pawan.jpg" alt="" />
                  </div>
                  <div className="committeeMemberDetails">
                    <h6>XJ PAWAN BERI</h6>
                    <p>
              ...
              <div className="col-lg-3 col-md-6  col-md-6">
                <div className="committeeContainer">
                  <div className="othersMembersImage">
                    <img src="/images/managing/abhishek.jpg" alt="" />
                  </div>
                  <div className="committeeMemberDetails">
              ...
              <div className="col-lg-3 col-md-6 col-md-6">
                <div className="committeeContainer">
                  <div className="othersMembersImage">
                    <img src="/images/managing/vivek-mehra.jpg" alt="" />
                  </div>
                  <div className="committeeMemberDetails">
              ...
              <div className="col-lg-3 col-md-6  col-md-6">
                <div className="committeeContainer">
                  <div className="othersMembersImage">
                    <img src="/images/managing/XJ-anurag.jpg" alt="" />
                  </div>
                  <div className="committeeMemberDetails">
              ...
              <div className="col-lg-3 col-md-6  col-md-6">
                <div className="committeeContainer">
                  <div className="othersMembersImage">
                    <img src="/images/managing/XJ-abhinav.jpg" alt="" />
                  </div>
                  <div className="committeeMemberDetails">
                    <h6>XJ ABHINAV KM</h6>
                    <p>
              ...
              <div className="col-lg-3 col-md-6  col-md-6">
                <div className="committeeContainer">
                  <div className="othersMembersImage">
                    <img src="/images/managing/XJ-shikha.jpg" alt="" />
                  </div>
                  <div className="committeeMemberDetails">
                    <h6>XJ SHIKHA DAS</h6>
                    <p>
              ...
              <div className="col-lg-3 col-md-6 col-md-6">
                <div className="committeeContainer">
                  <div className="othersMembersImage">
                    <img src="/images/managing/XJ-kartikanand.jpg" alt="" />
                  </div>
                  <div className="committeeMemberDetails">
              ...
              <div className="col-lg-3 col-md-6  col-md-6">
                <div className="committeeContainer">
                  <div className="othersMembersImage">
                    <img src="/images/managing/XJ-Tushar.jpg" alt="" />
                  </div>
                  <div className="committeeMemberDetails">
              ...
              <div className="col-lg-3 col-md-6  col-md-6">
                <div className="committeeContainer">
                  <div className="othersMembersImage">
                    <img src="/images/managing/XJ-Ankur.png" alt="" />
                  </div>
                  <div className="committeeMemberDetails">
              ...
              <div className="col-lg-3 col-md-6  col-md-6">
                <div className="committeeContainer">
                  <div className="othersMembersImage">
                    <img src="/images/managing/XJ-Jaideep.jpg" alt="" />
                  </div>
                  <div className="committeeMemberDetails">
              ...
              <div className="col-lg-3 col-md-6 col-md-6">
                <div className="committeeContainer">
                  <div className="othersMembersImage">
                    <img src="/images/managing/XJ-Ritesh.jpg" alt="" />
                  </div>
                  <div className="committeeMemberDetails">
